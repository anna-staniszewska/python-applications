...
if __name__ == "__main__":
    queue = IncidentQueue()
    incident1 = Incident("Power outage in sector 4")
    incident2 = Incident("Fire alarm in building 21")
    incident4 = Incident("Fire alarm in building 129")
    ...
    new_incident = Incident("Test incident")
